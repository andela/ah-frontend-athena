...
describe('test profile edit component', () => {
  ...
  it('should set state on change', () => {
    wrapper.instance().Change({target:{name: 'email', value: 'me@andela.com'}})
    expect(wrapper.state('email')).toEqual('me@andela.com')
  })
  it('should submit changes', () => {
    wrapper.find('form').simulate('submit', {target:{username: 'ntale', email: '', bio: '', image: ''}})
...
it('test component should receive props', () => {
  wrapper.setProps({profile : {username: 'shadik', email: '', bio: '', image: ''}})
