...
export class profileEdit extends Component {
  ...
  render() {
    ...
    return (
      <ProfileEdit data={values} Change={this.Change} Submit={this.Submit} onchange={this.onChange}  />
    )
  }
...
export default connect(mapStateToProps, {updateProfile, getProfile })(profileEdit)
