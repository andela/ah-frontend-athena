...
describe("Test like component", () => {
  ...
  it("Test component will receive props", () => {
    wrapper.setProps({ likesData: {}, returnData: { like: "true" } });
  ...
  it("Test click icon 1", () => {
    ...
    wrapper
      ...
      .first()
      .simulate("click");
    expect(wrapper.instance().props.props.LikeIcon).toBeCalled();
  });
  ...
  it("Test click icon 2", () => {
    ...
    wrapper
      ...
      .first()
      .simulate("click");
    expect(wrapper.instance().props.props.DisLikeIcon).toBeCalled();
  });
});
