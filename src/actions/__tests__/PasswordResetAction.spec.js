...
describe('password reset actions', () => {
  ...
  it('test password reset actions success', () => {
    fetchMock.postOnce('https://ah-backend-athena-staging.herokuapp.com/api/password_reset/', {
...
describe('password reset confirm actions', () => {
  ...
  it('test password confirm reset actions', () => {
    fetchMock.putOnce('https://ah-backend-athena-staging.herokuapp.com/api/password_reset_confirm/mocktoken', {
      headers: {'content-type':'application/json'},
      body: {message:"message"}
    })
    const expectedActions = [{
    ...
    return store.dispatch(actions.PasswordResetConfirmAction('mockpassword','mocktoken')).then(() => {
      expect(store.getActions()).toEqual(expectedActions)
    })
  })
  it('test password confirm reset actions', () => {
