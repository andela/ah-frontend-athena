...
import { MDBContainer, MDBRow, MDBCol, MDBBtn, MDBCard, MDBCardBody, MDBInput, MDBIcon,MDBModalFooter  } from 'mdbreact';
              ...
              <MDBCard>
                ...
                <MDBCardBody className="mx-4 mt-4 grey-text">
                  <MDBInput
                    ...
                    onChange={onChange}
                    group
                    className={classnames('form-control mb-0 form-control-lg ', {'is-valid': errors.username})}
                    containerClass="mb-0"
                    type="text"
                    icon="user"
                    required
                  ...
                  <MDBInput
                    ...
                    icon="envelope"
                    group
                    className={classnames('form-control mb-0 form-control-lg ', {'is-valid': errors.email})}
                    type="email"
                    validate
                  />
                  ...
                  <MDBInput
                    ...
                    containerClass="mb-0"
                    required
                    className={classnames('form-control mb-0 form-control-lg', {'is-valid': errors.password})}
                  />
